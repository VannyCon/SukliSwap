...
class AdminManager {
    ...
    async loadDashboardStats() {
        try {
            const response = await axios.get(`${adminAPI}?action=getDashboardStats`, {
                headers: headerAPI
            });
    ...
    async loadRecentActivity() {
        try {
            const response = await axios.get(`${adminAPI}?action=getRecentActivity`, {
                headers: headerAPI
            });
    ...
    async loadUsers(filter = '', search = '') {
        try {
            ...
            const response = await axios.get(`${adminAPI}?${params}`, {
                headers: headerAPI
            });
    ...
    async loadSettings() {
        try {
            const response = await axios.get(`${adminAPI}?action=getSystemSettings`, {
